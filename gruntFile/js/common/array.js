define("dzp/common/array",['dzp/common/util'],function(require){
    var DZPFM = require("dzp/common/util");
    DZPFM.Array = {
        /**
         * 返回数组的最后一个对象
        ...
        contains : function(value,array){
            return DZPFM.Array.indexOf(value,array) >=0;
        },
        /**
         * 遍历数组或者对象
         * @method
        ...
        filter : function(array,func){
            var result = [];
            DZPFM.Array.each(array,function(value,index){
                if(func(value,index)){
                    result.push(value);
                }
            });
        ...
        find : function(array,func){
            var i = DZPFM.Array.findIndex(array, func);
        ...
        addAt : function(array,value,index){
            DZPFM.Array.splice(array, index, 0, value);
        },
        /**
         * 清空数组
         * @param  {Array} array 数组
        ...
        remove : function(array,value){
            var i = DZPFM.Array.indexOf(value, array);
            var rv;
            if ((rv = i >= 0)) {
                DZPFM.Array.removeAt(array, i);
            }
            return rv;
        },
        /**
        ...
        removeAt : function(array,index){
            return DZPFM.Array.splice(array, index, 1).length == 1;
        },
        /**
         * @private
         */
        ...
        splice : function(arr, index, howMany, var_args){
            return Array.prototype.splice.apply(arr, DZPFM.Array.slice(arguments, 1))
        }
    };
    return DZPFM.Array;
});